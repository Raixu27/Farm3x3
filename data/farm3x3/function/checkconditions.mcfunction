...
execute if items entity @s weapon.mainhand #minecraft:hoes unless items entity @s weapon.offhand #minecraft:hoes unless predicate farm3x3:is_sneaking at @s anchored eyes positioned ^ ^ ^2 at @e[type=item,distance=..2,nbt={Age:0s}] run function farm3x3:getareaforharvest with storage farm3x3:temp_replant_data
execute if items entity @s weapon.offhand #minecraft:hoes unless predicate farm3x3:is_sneaking at @s anchored eyes positioned ^ ^ ^2 at @e[type=item,distance=..2,nbt={Age:0s}] run function farm3x3:getareaforharvest with storage farm3x3:temp_replant_data
