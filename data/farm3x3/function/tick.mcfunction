...
execute as @a if score @s farm3x3_wheat_Mined matches 1.. as @s run function farm3x3:checkconditions {Crop:"minecraft:wheat"}
...
execute as @a if score @s farm3x3_potatoes_Mined matches 1.. as @s run function farm3x3:checkconditions {Crop:"minecraft:potatoes"}
...
execute as @a if score @s farm3x3_carrots_Mined matches 1.. as @s run function farm3x3:checkconditions {Crop:"minecraft:carrots"}
...
execute as @a if score @s farm3x3_beetroots_Mined matches 1.. as @s run function farm3x3:checkconditions {Crop:"minecraft:beetroots"}
...
execute as @a if score @s farm3x3_nether_wart_Mined matches 1.. as @s run function farm3x3:checkconditions {Crop:"minecraft:nether_wart"}